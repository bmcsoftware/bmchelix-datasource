...
export class EventBucketAggCtrl {
  /** @ngInject */
...
export function eventBucketAgg() {
  return {
    templateUrl: TEMPLATE_BASE_URL + '/partials/event/bucket_agg.html',
    controller: EventBucketAggCtrl,
    restrict: 'E',
    scope: {
      target: '=',
      index: '=',
...
coreModule.directive('eventBucketAgg', eventBucketAgg);
