...
export class EventMetricAggCtrl {
  /** @ngInject */
  constructor($scope: any, uiSegmentSrv: any, $rootScope: any) {
    const metricAggs: EventAggregation[] = $scope.target.metrics;
...
export function eventMetricAgg() {
  return {
    templateUrl: TEMPLATE_BASE_URL + '/partials/event/metric_agg.html',
    controller: EventMetricAggCtrl,
    restrict: 'E',
    scope: {
      target: '=',
      index: '=',
...
coreModule.directive('eventMetricAgg', eventMetricAgg);
