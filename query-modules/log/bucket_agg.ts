...
export function logBucketAgg() {
  return {
    templateUrl: TEMPLATE_BASE_URL + '/partials/log/bucket_agg.html',
    controller: LogBucketAggCtrl,
    restrict: 'E',
    scope: {
      target: '=',
      index: '=',
...
coreModule.directive('logBucketAgg', logBucketAgg);
