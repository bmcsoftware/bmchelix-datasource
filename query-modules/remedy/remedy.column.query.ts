...
export class RemedyColumnQueryCtrl {
  ...
  constructor($scope: any, uiSegmentSrv: any, $rootScope: any) {
    ...
    $scope.updateFullColumnList = () => {
      ...
      $scope.inputAutoComplete.selectionColumnName = queryDef.getColumnNames();
      ...
      Promise.all(result).then((columnList) => {
        ...
        $scope.inputAutoComplete.selectionColumnName = modifiedColumList;
        ...
        $rootScope.inputAutoComplete[$scope.target.guid].metaColumnNames = $scope.inputAutoComplete.selectionColumnName;
