...
import { ElasticsearchQuery, LogAggregation, LogDataSourceQuery } from './logTypes';
import {
  DataFrame,
  DataQueryResponse,
  FieldType,
...
export class LogResponse {
  constructor(private targets: LogDataSourceQuery[], private response: any) {
    this.targets = targets;
    this.response = response;
  }

  processMetrics(esAgg: any, target: LogDataSourceQuery, seriesList: any, props: any) {
    let newSeries: any;
  ...
  processAggregationDocs(esAgg: any, aggDef: LogAggregation, target: LogDataSourceQuery, table: any, props: any) {
    // add columns
  ...
  trimDatapoints(aggregations: any, target: LogDataSourceQuery) {
